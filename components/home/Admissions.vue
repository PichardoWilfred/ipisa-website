<template>
    <section class="relative w-full max-w-[1680px] mx-auto px-[5vw] pt-[2rem] z-20" id="admissions">
        ...
        <div class="home-admission-required hidden relative justify-center h-[35vh] z-10 overflow-hidden">
